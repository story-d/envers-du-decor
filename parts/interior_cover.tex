...
\begin{titlepage}
    \centering
    \vspace*{3cm}
    {\fontsize{\titlepageBig}{48}\selectfont \textcolor{black}{\textbf{L'envers du décor}}}\\[0.5cm]
    {\fontsize{\titlepageMid}{40}\selectfont \textcolor{black}{des Entreprises}}\\[0.25cm]
    {\fontsize{\titlepageBig}{48}\selectfont \textcolor{black}{Libérées}}\\[2cm]
    {\fontsize{12}{19.2}\selectfont \textcolor{black}{Kevin Delfour}}\\[3pt]
    \vfill
\end{titlepage}
...
\begin{flushleft}
    ...
    \textbf{ISBN : } 000-00-000-0000-0 \\[0.25cm]
    \textbf{Contact : } kevin@delfour.co
