\insertImage{fde831f5-1dd5-468b-8682-1d0e38a05cc0.jpg}{Aquarelle d'une réunion d'équipe dans une entreprise libérée, avec des employés partageant des idées et prenant des décisions ensemble.}

\chapter{La communication et la prise de décision}

\lettrine[lines=2]{F}{aites} l'exercice avec moi. Dans votre entreprise, aujourd'hui, qui décide d'embaucher quelqu'un ? Qui décide d'un achat à dix mille euros ? Qui décide qu'un projet s'arrête ?
