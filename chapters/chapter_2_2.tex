...
\begin{figure}[H]
    \center
    \includegraphics[keepaspectratio, width=\textwidth, height=\textheight]{images/c84dac79-ff25-4546-b995-f36426a4b677.png}
    \caption{Aquarelle d'une carte de chasse au trésor à l'ancienne avec des chemins croisés et un chemin vers le trésor. La carte présente des endroits tels que des gouffres, des rivières avec des crocodiles et des montagnes représentant les difficultés pour arriver à libérer l'entreprise.\\
