\insertImage{cfe76e97-852f-4871-9dda-e3a597c43a27.jpg}{Aquarelle d'une réunion d'équipe dans une entreprise libérée, avec des employés travaillant devant un tableau blanc et regardant ensemble un graphique d'entreprise sur le tableau blanc.}

\chapter{La performance et la rentabilité}

\lettrine[lines=2]{À}{} un moment ou à un autre, la question tombe. En comité de direction, en conseil d'administration, au détour d'un rendez-vous bancaire : « D'accord, vos équipes sont épanouies. Mais est-ce que ça rapporte ? »
