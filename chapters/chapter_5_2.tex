\insertImage{c4a662b0-2b67-4605-b38f-48b9e903fd03.jpg}{Aquarelle représentant deux salles de classe symbolisant la transition entre les systèmes éducatifs traditionnels et modernes.}

\chapter{Système éducatif et formation}

\lettrine[lines=2]{F}{aites} ce petit test : repensez à votre scolarité, et cherchez le moment où on vous a appris à travailler sans qu'on vous dise quoi faire.
...
De ma propre expérience de dirigeant d'entreprise libérée, je retiens un programme minimal, que j'appliquerais dès le premier jour si c'était à refaire. Former chacun à deux choses avant de lui transférer les décisions. D'abord, la vie économique d'une entreprise : ce que coûte réellement un salaire, ce qu'exige un client, ce qu'imposent la loi et la trésorerie — parce qu'on ne peut pas décider librement dans un monde dont on ignore les règles. Ensuite, le fonctionnement du modèle lui-même — ses rituels, ses rôles, ses limites. À partir de là, toute l'autonomie nécessaire. Avant, aucune : ce ne serait pas de la liberté, ce serait un piège.

Et une troisième chose, apprise en chemin : savoir s'entourer. Nous avons fait appel à des accompagnateurs extérieurs pour les sujets qui n'étaient pas notre métier — le commerce, les ressources humaines, le juridique. Des développeurs autonomes restent des développeurs : leur transférer une décision commerciale ou RH sans leur donner accès à quelqu'un qui connaît le terrain, ce n'est pas de la confiance, c'est de la négligence. L'autonomie ne signifie pas tout savoir faire ; elle signifie savoir ce qu'on ne sait pas, et aller chercher l'aide sans demander la permission.
