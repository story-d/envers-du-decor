\insertImage{b67bf4ba-580b-4672-b687-8310d1ca30f5.jpg}{Aquarelle d'une série de panneaux routiers sur une route sinueuse avec des chemins de terre qui se détachent de la route principale et semblent être des raccourcis.}

\chapter{Les causes des échecs}

\lettrine[lines=2]{P}{ersonne} n'écrit de communiqué de presse pour annoncer que sa libération a échoué.
...
Je parle en connaissance de cause. Quand j'ai libéré ma propre société — pas d'un coup : par expérimentations successives, avec le livre de Laloux comme boussole —, ma plus grosse erreur n'a été ni technique ni organisationnelle : elle a été pédagogique. Je n'ai pas assez dit, dès le départ, qu'il y aurait des cadres — certains déjà en place, d'autres à construire ensemble — et des contraintes de rentabilité tout à fait ordinaires, sans lesquelles le modèle ne peut tout simplement pas vivre. Il a fallu aussi beaucoup de pédagogie pour expliquer ce qui restait, quoi qu'il arrive, sur mes épaules : les responsabilités légales et financières d'un dirigeant ne se libèrent pas, elles. Quand on annonce la liberté sans annoncer le cadre, chacun dessine dans sa tête la liberté qui l'arrange — et la réalité se charge de la gommer. Si c'était à refaire, je commencerais par là : la pédagogie du cadre, avant la promesse de la liberté.
