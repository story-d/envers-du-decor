...
Vous voulez savoir si une entreprise est vraiment libérée ? Ne regardez pas ses réunions, ses valeurs affichées ni son organigramme aboli. Posez une seule question : \emph{comment s'y décident les salaires ?}
