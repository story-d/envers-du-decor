...
\hypersetup{
    ...
    pdftitle={L'envers du décor des entreprises libérées}, % Définit le titre du PDF
    pdfkeywords={entreprise libérée, holacratie, management, autonomie, organisation}, % Définit les mots-clés du PDF
